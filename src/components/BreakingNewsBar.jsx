  ...
  return (
    <div className="bg-[#E31E24] text-white shadow-md relative z-20" aria-label="Son Dakika Haberleri">
      <div className="max-w-7xl mx-auto flex items-stretch overflow-hidden">
        ...
        <div className="bg-[#B71015] px-4 sm:px-6 py-2.5 flex items-center gap-2.5 font-black text-xs sm:text-sm tracking-wider uppercase whitespace-nowrap shrink-0 shadow-inner">
        ...
        <div 
          className="flex-1 relative overflow-hidden flex items-center px-4"
        ...
        >
          <div className="w-full flex items-center justify-between">
            <Link
              href="/haber/1"
              key={currentIndex}
              className="text-sm sm:text-base font-extrabold truncate text-white hover:text-amber-200 transition-all duration-300 inline-block py-1 animate-fade-in tracking-tight"
            >
